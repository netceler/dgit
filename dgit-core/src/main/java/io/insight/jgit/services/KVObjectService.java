...
public interface KVObjectService {
    ...
    void insertLooseObject(String repositoryName, AnyObjectId objectId, int objectType, long inflatedSize,
            InputStream in, long length) throws IOException;
    ...
    void insertPackedObject(String repositoryName, AnyObjectId objectId, int typeCode, long inflatedSize,
            long totalSize, @Nullable String base, SeekableByteChannel channel, long offset, long size)
            throws IOException;
}