...
@Testcontainers
public class MySQLRepoTest extends BaseRepoTest {
    @Container
    private final static JdbcDatabaseContainer DATABASE = new MySQLContainer().withInitScript("mysql-init.sql").withDatabaseName("foo").withUrlParam("loggerLevel", "ON");
