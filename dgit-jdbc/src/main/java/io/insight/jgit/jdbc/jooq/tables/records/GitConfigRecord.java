...
public class GitConfigRecord extends UpdatableRecordImpl<GitConfigRecord> implements Record2<String, String> {
     ...
     */
    @Override
    public GitConfigRecord value1(final String value) {
        setRepo(value);
        return this;
    }
     ...
     */
    @Override
    public GitConfigRecord value2(final String value) {
        setConfig(value);
        return this;
    }
     ...
     */
    @Override
    public GitConfigRecord values(final String value1, final String value2) {
        value1(value1);
        value2(value2);
        return this;
    }
     ...
     */
    public GitConfigRecord(final String repo, final String config) {
        super(GitConfig.GIT_CONFIG);
